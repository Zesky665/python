...
def clean_ingredients(dish_name: str, dish_ingredients: list[str, list[str]]) -> tuple[str, set[str]]:
...
def singleton_ingredients(dishes: list[dict[str]], intersection: dict[str]) -> set[str]:
    ...
    singeltons = set()
    for dish in dishes:
        singeltons = singeltons.symmetric_difference(dish)
        singeltons = singeltons - intersection
