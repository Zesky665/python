...
def value_of_ace(card_one, card_two):
    ...
    if value_of_card_one + value_of_card_two >= 11:
        return 1
...
def is_blackjack(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    first_condition = 1 in [value_of_card(card_one), value_of_card(card_two)]
    second_condition = 10 in [value_of_card(card_one), value_of_card(card_two)]
